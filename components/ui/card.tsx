...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border-2 border-transparent bg-card text-card-foreground shadow-dramatic transition-all duration-400 ease-out-back hover:shadow-card-hover hover:border-accent/20",
      className
    )}
    {...props}
  />
